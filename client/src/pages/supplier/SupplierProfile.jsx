...
export default function SupplierProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate("/supplier/dashboard/overview"), 1200);
    } catch (e) {
      setErr(e.message);
    } finally {
      setSaving(false);
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-6">
          <form
            ...
            className="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-6 space-y-5"
          >
            <div>
          ...
          <div className="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-6 space-y-5">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-xs text-slate-500">
                Click "Browse" to upload a new photo
              </p>
            </div>
          </div>
        </div>
